...
const ChatBot = () => {
  ...
  return (
    <>
      {/* Circular chat button (always visible) */}
      <button
        onClick={() => setIsOpen(true)}
        className={`fixed bottom-6 right-6 z-40 bg-gradient-to-r from-blue-800 to-purple-800 text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all ${
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-end p-4 pointer-events-none">
          ...
          <div className={`relative transition-all duration-300 ${
            ...
            <div className="w-full bg-white shadow-xl rounded-lg flex flex-col border border-gray-200 overflow-hidden">
              {/* Chat header */}
